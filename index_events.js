...
function reviewreports(){
    ...
    //ACTIVE
    const reviewreports_container = document.getElementById('reviewreports_container');
    reviewreports_container.style.display = "flex";
    //NOT ACTIVE
    const reviewqueries_container = document.getElementById('reviewqueries_container');
