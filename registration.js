...
const firebaseConfig = {
  ...
  databaseURL: "https://parseit-teamfive-default-rtdb.asia-southeast1.firebasedatabase.app",
        ...
        if(snapshot.exists()){
            if (snapshot.val().verificationcode == null ){
                ...
                if(input_code == snapshot.val().verificationcode){
                    ...
                    const div_fillout_container = document.getElementById('div_fillout_container');
...
step5_btn.addEventListener('click', (event) => {
    var email = document.getElementById('email_txt').value;
    var fullname = document.getElementById('txtfirstname').value + " " + document.getElementById('txtmidname').value + " " + document.getElementById('txtlastname').value + " " + document.getElementById('txtsuffixname').value;
    var birthday = document.getElementById('txtbirthmonth').value + " " + document.getElementById('txtbirthday').value + " " + document.getElementById('txtbirthyear').value;
